...
| 7.5 | Crawler Bugetul de Stat (XML MF 2023-2025) | ✅ **done** |
...
| ID | Ticket | Status |
|----|--------|--------|
| 8.1 | Spike + Crawler Buletin Statistic Fiscal ANAF | ✅ **done** |
...
| 11.2 | Rețea școlară (crawler ME + API + pagină) | 📋 ready (ticket scris) |
