...
const domains = [
  ...
  { name: "Companii și Comerț", slug: "companii" },
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
        {domains.map((domain) => (
          <a
            key={domain.slug}
            href="#"
            className="group flex items-center gap-2.5 rounded-lg border border-border-subtle bg-bg-surface px-3 py-2.5 transition-all hover:border-border-default hover:bg-bg-elevated"
          >
            <span
